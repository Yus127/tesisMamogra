...
linear_probe = CLIPLinearProbe.load_from_checkpoint('david_test/linear_probe/version_16/checkpoints/epoch=501-step=42670.ckpt', model=model, class_descriptions=class_descriptions) 
